...
parser.add_argument('--name', type=str, default='fastText1609')
parser.add_argument('--checkpoint_dir', type=str, default='./ckpt/')
parser.add_argument('--seed', type=int, default=2019)
parser.add_argument('--data_path', type=str, default='./data/sogou_news_csv/sogou_news_csv/sogou.pkl')
parser.add_argument('--num_classes', type=int, default=10)

parser.add_argument('--n_grams', type=int, default=2)
parser.add_argument('--embedding_dim', type=int, default=10)
parser.add_argument('--vocab_size', type=int, default=1299902)
...
def main():
    ...
    data_path = './data/sogou_news_csv/sogou_news_csv/sogou.pkl'
